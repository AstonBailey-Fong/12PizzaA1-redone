Public Class Pizza107
    ...
    Private Sub BtnAddStud_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Else
            ...
            End If
        End If
        If txtQuantity.Text < 1 Then 'Quantity Check
            MsgBox("Please enter in a quantity", MsgBoxStyle.Exclamation, "Quantity Check")
            txtQuantity.Focus()
            Exit Sub
        End If
        If cboHour.Text = "" Then 'Hour Check
            MsgBox("Please enter in an hour from the dropdown box", MsgBoxStyle.Exclamation, "Time Check")
            cboHour.Focus()
            Exit Sub
        End If
        If cboHour.Text < 10 Or cboHour.Text > 22 Then
            MsgBox("Please enter in an hour between 10 and 22", MsgBoxStyle.Exclamation, "Time Check")
            cboHour.Focus()
            Exit Sub
        End If
        ...
        students(studentCount) = New STUDENT(studentCount + 1, txtFirstName.Text, txtLastName.Text, dteDelivery.Text & " " & cboHour.Text & ":" & cboMinute.Text,
                                             ...
                                             selectedType, chkPaid.Checked, chkTop1.Checked, chkTop2.Checked, chkTop3.Checked, chkTop4.Checked, CBOPFlav.Text)
        studentCount += 1
    ...
    Private Sub CheckBox5_CheckedChanged(sender As Object, e As EventArgs) Handles chkPaid.CheckedChanged
